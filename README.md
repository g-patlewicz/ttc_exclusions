...
To use the notebooks, clone the repo, then manually insert the relevant data files based on the project organisation shown below. Data files are supplied as a compressed tar file from the doi link.  
